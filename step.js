...
function Get_st3(){
  ...
  this.damage=function(){
    ...
    noTint();
    this.dmgRed-=40;if(this.dmgRed<=0){this.dmgRed=0;wcW=320;wcH=240;wcWs=320;wcHs=240;}
  ...
  this.attack=function(){
    ...
    // Atked
      ...
      if(randomX===0||randomX>width-5){
        /*hp reduce*/curHP-=2;
        //red screen
        this.outRed-=10;if(this.outRed<10){this.outRed=100;}
      ...
      if(this.r2>this.rRad*0.9&&this.x+this.r2>=randomX+33&&this.x-this.r2<=randomX+62&&this.y+this.r2>=randomY-85&&this.y-this.r2<=randomY+20){
        curHP-=4+(lvUp*0.5);
